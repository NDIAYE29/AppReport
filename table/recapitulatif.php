...
$pdf=new FPDF('P','mm',array(580,350));
...
$pdf->Cell(70,12,'Responsable',1,0,'L',1);
...
$result=$con->query("select nomRes,reference,varieteSouhaite,typeVariete,quantite,pu
from commande 
order by nomRes");
...
$ligne=array_values($ligne); */
  ...
  while ($donnees=$result->fetch(PDO::FETCH_NUM)){
   ...
   $pdf->SetFont('Arial','',18);
	...
	$pdf->Cell(70,12,$donnees[5],1,0,'L',1);
